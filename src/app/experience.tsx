...
/**
 * Base Experience：全局唯一的智能开关读取点。
 *
 * 规则只有一条：off = 不挂载，而不是 CSS 隐藏。路由、深链和后端命令一律保持
 * 可达，所以这里只管"要不要出现在主路径上"。
 *
 * Context Intelligence 与 Context Delivery 是两个正交开关：
...
/** True when the launch preview should show nothing at all. */
